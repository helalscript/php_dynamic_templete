...
$G_query=$con->query('select * from general_info');
$data=$G_query->fetch_assoc();
// echo '<pre>';
// Print_r($data);
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control" id="exampleInputEmail1" placeholder="Enter address"><?php echo $data['address'] ?></textarea>
                                    </div>
                                </div>
                                <div class="col-6">
                                <div class="form-group">
                                        <label for="exampleInputEmail1">Email</label>
                                        <input type="text" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Email" value="<?php echo $data['email'] ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="about" class="form-control" id="exampleInputEmail1" placeholder="Enter About"><?php echo $data['about'] ?></textarea>
                                    </div>
                                </div>
                            </div>
